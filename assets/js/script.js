...
const CORRECT_PASSWORD = "888"; // Altere aqui para a senha desejada
...
function initContentWarning() {
    ...
    if (acceptBtn) {
        acceptBtn.addEventListener('click', function() {
            // Esconder os botões e mostrar o teclado numérico
    ...
    function updatePasswordDisplay() {
        // Mostrar asteriscos
        passwordDisplay.value = '*'.repeat(currentPassword.length);
    }
